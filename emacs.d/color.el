...
(custom-set-faces
 ...
 '(develock-long-line-1 ((((background dark)) (:foreground "orange"))))
 '(develock-long-line-2 ((t (:foreground "orange"))))
 '(font-lock-comment-face ((t (:foreground "OrangeRed"))))
; '(develock-long-line-2 ((((background dark)) (:foreground "orange"))))
; '(develock-long-line-2 ((((background dark)) nil)))
; '(develock-long-line-2 ((t (:background "black" \, :forground "red"))))
)
